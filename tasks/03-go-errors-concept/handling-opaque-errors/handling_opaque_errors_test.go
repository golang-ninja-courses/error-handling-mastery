...
func Test_ErrorsImplementInterfaces(t *testing.T) {
	...
	assert.Implements(t, (*shouldBeSkipped)(nil), &NotFoundError{})
	assert.Implements(t, (*shouldBeSkipped)(nil), &AlreadyDoneError{})
	assert.Implements(t, (*shouldBeSkipped)(nil), &InvalidIdError{})
}
